...
/* ==========================================
   ...
   ========================================== */
// 1. 先抓取商家名稱
$store_sql = "SELECT store_name FROM stores WHERE store_id = $current_id";
...
$sql_today = "SELECT revenue, order_count, new_users FROM store_daily_stats WHERE store_id = $current_id AND record_date = CURDATE()";
