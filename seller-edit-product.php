...
/* ==========================================
   ...
   ========================================== */
$sql_get_p = "SELECT * FROM seller_product WHERE id = $product_id AND store_id = $current_id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit_edit'])) {
    ...
    $sql_update = "UPDATE seller_product 
                   ...
                   WHERE id = $product_id AND store_id = $current_id";
...
<body>
  ...
  <main class="edit-container">
    <div class="edit-card">
      ...
      <div class="section-subtitle">商品編號：#<?php echo $product['id']; ?></div>
