...
$sql_users_count = "SELECT COUNT(*) as cnt FROM users";
$res = mysqli_query($conn, $sql_users_count);
$total_users = (int)mysqli_fetch_assoc($res)['cnt'];

$sql_stores_count = "SELECT COUNT(*) as cnt FROM stores";
...
// ==========================================================================
$sql_commission = "SELECT s.store_name, SUM(d.revenue) as total_revenue
                    FROM store_daily_stats d
...
// ==========================================================================
$bar_data = [['商家', '總營收']];
$sql_bar = "SELECT s.store_name, SUM(d.revenue) as total_revenue
            FROM store_daily_stats d
            JOIN stores s ON d.store_id = s.store_id
            GROUP BY d.store_id, s.store_name
            ORDER BY total_revenue DESC
...
// ==========================================================================
$sql_user_year = "SELECT YEAR(created_at) as yr, COUNT(*) as cnt FROM users GROUP BY yr ORDER BY yr ASC";
...
$sql_store_year = "SELECT YEAR(created_at) as yr, COUNT(*) as cnt FROM stores GROUP BY yr ORDER BY yr ASC";
